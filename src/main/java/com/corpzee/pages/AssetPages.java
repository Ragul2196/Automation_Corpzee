...
public class AssetPages {
	...
	// Purchase Invoice
	private By purchaseInvoice = By.cssSelector("p-select[formControlName='purchaseInvoiceId']");

	// Add Another Asset
	private By addAnotherAssetButton = By.xpath("//button[.//span[normalize-space()='Add Another Asset']]");

	// Asset accordion panels
	private By assetPanels = By.cssSelector("p-accordion-panel");

	// Category
	private By category = By.cssSelector("p-select[formControlName='category']");

	// Sub Category
	private By subCategory = By.cssSelector("p-select[formControlName='subCategory']");

	// Asset Name
	private By assetName = By.cssSelector("input[formControlName='assetName']");

	// Brand / Model
	private By brandModel = By.cssSelector("input[formControlName='brandModel']");

	// Serial Number
	private By serialNumber = By.cssSelector("input[formControlName='serialNumber']");

	// Warranty Start Date
	private By warrantyStartDate = By.cssSelector("p-datepicker[formControlName='warrantyStartDate'] input");

	// Warranty End Date
	private By warrantyEndDate = By.cssSelector("p-datepicker[formControlName='warrantyEndDate'] input");

	// AMC Applicable
	private By amcApplicable = By.cssSelector("p-select[formControlName='amcApplicable']");

	// Submit
	private By submitForVerification = By.xpath("//button[.//span[normalize-space()='Submit for Verification']]");
...
//Allocate To
	...
	private By AllocateAsset = By.xpath("/html/body/app-root/app-base/div/div/div/div/app-asset-base/div/div[2]/app-asset-allocation/div/div/app-dynamic-report-page/div/app-dynamic-report-page-header/div/div/div[2]/button");
	
	
	
	private By allocationAssignee = By.xpath(
		    "//label[contains(normalize-space(),'Allocate To')]" +
		    "/following-sibling::p-select[1]//input"
		);


	private By allocationAsset = By
			.xpath("//label[contains(normalize-space(),'Select Asset')]/following-sibling::p-select[1]");

	
	private By allocationDate = By.xpath("//p-datePicker//input[@placeholder='Select Allocation Date']");


	private By expectedReturnDate = By.xpath("//p-datePicker//input[@placeholder='Select Return Date (Optional)']");


	private By requireAcknowledgement = By.id("ack");


	private By confirmAllocation = By.xpath("//button[.//span[normalize-space()='Confirm Allocation']]");


	private By allocationCancel = By.xpath("//button[normalize-space()='Cancel']");

	
	//Error Monitoring
	private By allocationErrorMessage = By.xpath(
		    "//*[contains(normalize-space(), 'Http failure response')]"
		);
	
	
	
	private By toastMessage = By.cssSelector(
		    ".p-toast-message"
		);

		private By toastSummary = By.cssSelector(
		    ".p-toast-summary"
		);

		private By toastDetail = By.cssSelector(
		    ".p-toast-detail"
		);
	...
	public void clickSideMenu(String menuName) {
		...
		WebElement menuItem = wait.until(ExpectedConditions.elementToBeClickable(
				By.xpath("//div[contains(@class,'asset-sidebar')]//a[.//span[normalize-space()='" + menuName + "']]")));
	...
	public void clickCatagory() {
		...
		WebElement AddButton = wait.until(ExpectedConditions.elementToBeClickable(AddCatagory));
	...
	public String getCategoryCode() {
		WebElement element = wait.until(ExpectedConditions.visibilityOfElementLocated(categoryCode));
	...
	public void clickSubcatagoryButton() {
		...
		WebElement AddButton = wait.until(ExpectedConditions.elementToBeClickable(AddSubButton));
	...
	public void selectParentCategory(String categoryName) {
		...
		WebElement dropdown = wait.until(ExpectedConditions.elementToBeClickable(parentCategory));

		dropdown.click();

		By option = By.xpath("//*[contains(@class,'p-select-option') and normalize-space()='" + categoryName + "']");
	...
	public void enterSubCategoryName(String name) {
		...
		WebElement element = wait.until(ExpectedConditions.visibilityOfElementLocated(subCategoryName));
	...
	public String getSubCategoryCode() {
		...
		WebElement element = wait.until(ExpectedConditions.visibilityOfElementLocated(subCategoryCode));
	...
	public String getSubStatus() {
		...
		WebElement element = wait.until(ExpectedConditions.visibilityOfElementLocated(substatus));
	...
	public void clickSubmitSubCategory() {
		...
		WebElement button = wait.until(ExpectedConditions.elementToBeClickable(subsubmitButton));
	...
	public String getSubSubmittedMessage() {
		...
		WebElement alert = wait.until(ExpectedConditions.visibilityOfElementLocated(subsuccessAlert));
	...
	public void clickAddPurchase() {
		...
		WebElement purchase = wait.until(ExpectedConditions.elementToBeClickable(AddPurchase));
	...
	public void enterVendorName(String name) {
		...
		WebElement element = wait.until(ExpectedConditions.visibilityOfElementLocated(vendorName));
	...
	public void enterVendorMobile(String mobile) {
		...
		WebElement element = wait.until(ExpectedConditions.visibilityOfElementLocated(vendorMobile));
	...
	public void enterVendorEmail(String email) {
		...
		WebElement element = wait.until(ExpectedConditions.visibilityOfElementLocated(vendorEmail));
	...
	public void enterVendorState(String state) {
		...
		WebElement element = wait.until(ExpectedConditions.visibilityOfElementLocated(vendorState));
	...
	public void enterVendorCity(String city) {
		...
		WebElement element = wait.until(ExpectedConditions.visibilityOfElementLocated(vendorCity));
	...
	public void enterInvoiceNumber(String invoice) {
		...
		WebElement element = wait.until(ExpectedConditions.visibilityOfElementLocated(invoiceNumber));
	...
	public void enterInvoiceDate(String date) {
		...
		WebElement element = wait.until(ExpectedConditions.elementToBeClickable(invoiceDate));
	...
	public void enterPurchaseValue(String value) {
		...
		WebElement element = wait.until(ExpectedConditions.visibilityOfElementLocated(purchaseValue));
	...
	public void selectGstType(String gst) {
		...
		WebElement dropdown = wait.until(ExpectedConditions.elementToBeClickable(gstType));

		dropdown.click();

		By option = By.xpath("//*[contains(@class,'p-select-option') and normalize-space()='" + gst + "']");
	...
	public void enterGstPercentage(String percentage) {
		...
		WebElement element = wait.until(ExpectedConditions.visibilityOfElementLocated(gstPercentage));
	...
	public void enterTotalQuantity(String quantity) {
		...
		WebElement element = wait.until(ExpectedConditions.visibilityOfElementLocated(totalQuantity));
	...
	public void uploadInvoice(String filePath) {
		...
		WebElement file = wait.until(ExpectedConditions.presenceOfElementLocated(invoiceFile));
	...
	public void clickSaveEntry() {
		...
		WebElement button = wait.until(ExpectedConditions.presenceOfElementLocated(saveEntryButton));
...
////////////////////////////////////
	...
	public WebElement getAssetPanel(int index) {
		...
		wait.until(driver -> driver.findElements(assetPanels).size() > index);
	...
	public void selectPurchaseInvoice(String invoiceName) {
		...
		WebElement dropdown = wait.until(ExpectedConditions.elementToBeClickable(purchaseInvoice));

		dropdown.click();

		By option = By.xpath("//li[contains(@class,'p-select-option') and normalize-space()='" + invoiceName + "']");
	...
	public void selectAssetCategory(int index, String categoryName) {
		...
		By option = By.xpath("//li[contains(@class,'p-select-option') and normalize-space()='" + categoryName + "']");
	...
	public void selectRandomSubCategory(int index) {
		...
		List<WebElement> options = wait
				.until(ExpectedConditions.visibilityOfAllElementsLocatedBy(By.cssSelector("li.p-select-option")));

		if (options.isEmpty()) {
			throw new RuntimeException("No Sub-Categories available");
		}
	...
	public void selectAMC(int index, String value) {
		...
		By option = By.xpath("//li[contains(@class,'p-select-option') and normalize-space()='" + value + "']");
	...
	public void clickAddAnotherAsset() {
		...
		WebElement button = wait.until(ExpectedConditions.presenceOfElementLocated(addAnotherAssetButton));
	...
	public void openAsset(int index) {
		...
		WebElement header = panel.findElement(By.cssSelector("p-accordion-header"));
	...
	public void clickSubmitForVerification() {
		...
		WebElement button = wait.until(ExpectedConditions.presenceOfElementLocated(submitForVerification));
	...
	public void selectAllocationAssignee(String assignee) {

	    WebElement input = wait.until(
	        ExpectedConditions.elementToBeClickable(allocationAssignee)
	    );

	    input.click();

	    input.sendKeys(Keys.CONTROL, "a");
	    input.sendKeys(assignee);

	    By option = By.xpath(
	        "//li[contains(@class,'p-select-option') and " +
	        "contains(normalize-space(),'" + assignee + "')]"
	    );
	...
	public void selectAllocationAsset(String assetName) {

	    WebElement dropdown = wait.until(
	        ExpectedConditions.elementToBeClickable(allocationAsset)
	    );
	...
	public void enterAllocationDate(String date) {

	    WebElement element = wait.until(
	        ExpectedConditions.elementToBeClickable(allocationDate)
	    );
	...
	public void enterExpectedReturnDate(String date) {

	    WebElement element = wait.until(
	        ExpectedConditions.elementToBeClickable(expectedReturnDate)
	    );
	...
	public void selectRequireAcknowledgement() {
	...
	public String clickConfirmAllocation() {

	    WebElement button = wait.until(
	        ExpectedConditions.elementToBeClickable(confirmAllocation)
	    );
	    ...
	    String summary = toast.findElement(toastSummary).getText().trim();
	    String detail = toast.findElement(toastDetail).getText().trim();

	    System.out.println("Toast Type: " + summary);
	    System.out.println("Toast Message: " + detail);
